...
const getIGDBGamesController = asyncErrorWrapper(
...
const getIGDBGameController = asyncErrorWrapper(
  async (req: Request, res: Response) => {
...
const updateGameIGDBDataController = asyncErrorWrapper(
  async (req: Request, res: Response) => {
...
const updateAllGamesIGDBDataController = asyncErrorWrapper(
